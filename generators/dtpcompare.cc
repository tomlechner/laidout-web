//
//  dtpcompare, generate a pleasant comparison html table based on a config file
//
//  Copyright (C) 2017 Tom Lechner
//
...
"<br/>\n"
"THIS TABLE IS FAR FROM COMPLETE! Please send me updates, or post on the <a href=\"https://github.com/Laidout/laidout/issues\">issue tracker</a> \n"
...
"<br/>\n"
"Please note that I have no access to InDesign, Quark, Xara, or Illustrator, so the estimation of the capabilities of those programs might be totally wrong.\n"
